...
const OrganisationAdminSidebar = ({ collapsed, size, handleSizeChange }) => {
  return (
    <Sider trigger={null} collapsible collapsed={collapsed}>
      ...
      <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
        <SubMenu key="sub1" icon={<InsertRowAboveOutlined />} title="Agents">
          <Menu.Item key="1">
            <Link to={`${urls.organisationAdmin.viewAgents}/1`} />
            View Agents
          </Menu.Item>
        </SubMenu>
      </Menu>
...
OrganisationAdminSidebar.propTypes = {
  /** TODO:  */
...
export default OrganisationAdminSidebar;
